...
update Manutencao.._PARAMETROS set VALOR = '2025-01-07' where chave = 'DATA_CORTE'
...
update TUR_Turma set tur_dataEncerramento = '2024-12-22', tur_situacao = 5, tur_dataAlteracao = GETDATE() 
 where cal_id in (42,43,44,45,46) and tur_situacao = 1
