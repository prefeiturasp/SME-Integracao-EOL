...
BEGIN
    ...
    USING (select crd.cur_id, crd.crr_id, crd.crp_id, tds.tds_id, crd.crd_situacao, min(crd.crd_tipo) as crd_tipo,
                  max(crd.crd_dataCriacao) as crd_dataCriacao, max(crd.crd_dataAlteracao) as crd_dataAlteracao, crp.tcp_id
            ...
            group by crd.cur_id, crd.crr_id, crd.crp_id, tds.tds_id, crd.crd_situacao, crp.tcp_id ) Origem
     ON Destino.cur_id = Origem.cur_id
    AND Destino.crr_id = Origem.crr_id
    AND Destino.crp_id = Origem.crp_id
    ...
    WHEN NOT MATCHED THEN
         INSERT (cur_id, crr_id, crp_id, tds_id, crd_tipo, crd_situacao, crd_dataCriacao, crd_dataAlteracao ,tcp_id)
         VALUES (Origem.cur_id, Origem.crr_id, Origem.crp_id, Origem.tds_id, Origem.crd_tipo,
                 Origem.crd_situacao, Origem.crd_dataCriacao, Origem.crd_dataAlteracao, Origem.tcp_id)
                          ...
                          from (select prf.rf, gc.cd_escola
                                  from BD_PRODAM..v_cadastro_professor prf
									   ...
									   inner join DEPARA_SERIE dep on dep.cd_serie_ensino = tm.cd_serie_ensino
											  and ((dep.cur_id in (135,137,138) and dep.crp_ordem > 2) --EF (menos o de 4 horas) a partir do terceiro ano (a pedido do Hygor por email em 05/05/2016)
...
SELECT distinct cd_componente_curricular, dc_componente_curricular,
 ...
 WHERE cd_componente_curricular in (SELECT distinct cd_componente_curricular
									 ...
									 WHERE cd_etapa_ensino in (2,3,5,6,11,13,17) --infantil vai ser tratado separado
									 )
UNION
...
FROM    ( SELECT    cd_serie_ensino ,
        ...
        INNER JOIN GE_ACA_Curso cur WITH ( NOLOCK ) 
				ON cur.cur_nome COLLATE DATABASE_DEFAULT = _out.crr_nome COLLATE DATABASE_DEFAULT
				   or (cur.cur_id = 129 and _out.crr_nome = 'Ensino Fundamental Especial de 9 Anos')
				   or (cur.cur_id = 131 and _out.crr_nome = 'Ensino Médio Regular')
...
GROUP BY 
	...
	UPDATE #curCurriculoPeriodo SET cur_id = 141 where cur_id = 41
	...
	SELECT crp.crp_ordem, CAST(crp.crp_ordem as varchar(1))+'° ano', 5, crr_nome, 2, 5, 
		   CASE when crp.crp_ordem IN (1,2,3) THEN 'Ciclo de Alfabetização'  
		        ...
		        case when crr.cur_id = 130 then 249 + crp_ordem
				else 
						case crp_ordem 
	 ...
	 where div.cur_id not in (129,131,132,139,140,141,41,42,143,144,145)
	...
	delete from #curCurriculoPeriodo where cur_id in (125,126,127,128)
	
	INSERT INTO #curCurriculoPeriodo
	values (1, 'Fundamental I Libras', 13, 'Ensino Fundamental 9 Anos',                  2, 5, 'CICLO I',  0, 1, 132, 1, 1, 1, 0, 226)
	    ,(1, 'Fundamental I Libras', 13, 'Ensino Fundamental 9 Anos',                    2, 5, 'CICLO I',  0, 1, 133, 1, 1, 1, 0, 226)
		...
		,(1, 'EJA ALFABETIZACAO I' ,  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 139, 1, 8, 1, 0, 274)
		,(2, 'EJA ALFABETIZACAO II',  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 139, 1, 8, 2, 0, 275)	
		,(3, 'EJA BASICA I',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 139, 1, 8, 3, 0, 278)	
		,(4, 'EJA BASICA II',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 139, 1, 8, 4, 0, 280)	
		,(5, 'EJA COMPLEMENTAR I',    3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 139, 1, 8, 5, 0, 246)	
		,(6, 'EJA COMPLEMENTAR II',   3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 139, 1, 8, 6, 0, 247)	
		,(7, 'EJA FINAL I',			  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 139, 1, 8, 7, 0, 248)	
		,(8, 'EJA FINAL II',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 139, 1, 8, 8, 1, 249)	
		                                                                                                          
		,(1, 'EJA ALFABETIZACAO I',   3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 139, 1, 8, 1, 0, 276)
		,(2, 'EJA ALFABETIZACAO II',  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 139, 1, 8, 2, 0, 277)	
		,(3, 'EJA BASICA I',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 139, 1, 8, 3, 0, 279)	
		,(4, 'EJA BASICA II',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 139, 1, 8, 4, 0, 281)	
		,(5, 'EJA COMPLEMENTAR I',    3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 139, 1, 8, 5, 0, 265)	
		,(6, 'EJA COMPLEMENTAR II',   3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 139, 1, 8, 6, 0, 266)	
		,(7, 'EJA FINAL I',			  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 139, 1, 8, 7, 0, 267)	
		,(8, 'EJA FINAL II',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 139, 1, 8, 8, 1, 268)	
		                                                                                
		,(3, 'EJA BASICA I',		  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO I',  0, 1, 140, 1, 8, 3, 0, 292)	
		,(4, 'EJA BASICA II',		  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO I',  0, 1, 140, 1, 8, 4, 0, 294)	
		,(4, 'EJA BASICA II',		  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO I',  0, 1, 140, 1, 8, 4, 0, 295)	
		,(5, 'EJA COMPLEMENTAR I',    11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 140, 1, 8, 5, 0, 261)	
		,(6, 'EJA COMPLEMENTAR II',   11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 140, 1, 8, 6, 0, 270)	
		,(6, 'EJA COMPLEMENTAR II',   11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 140, 1, 8, 6, 0, 262)	
		,(7, 'EJA FINAL I',			  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 140, 1, 8, 7, 0, 263)	
		,(8, 'EJA FINAL II',		  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 140, 1, 8, 8, 1, 272)	
		
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 125, 1, 6, 5, 0, 23)	
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 125, 1, 6, 5, 0, 24)	
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 125, 1, 6, 5, 0, 225)
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 125, 1, 6, 6, 1, 118)
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 125, 1, 6, 6, 1, 25)	
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 125, 1, 6, 6, 1, 26)	
		                                                                                 
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 126, 1, 6, 5, 0, 23)	
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 126, 1, 6, 5, 0, 24)	
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 126, 1, 6, 5, 0, 225)
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 126, 1, 6, 6, 1, 118)
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 126, 1, 6, 6, 1, 25)	
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 126, 1, 6, 6, 1, 26)	
		                                                                                 
		,(4, 'Mini grupo II',          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 127, 1, 6, 4, 0, 28)	
		,(4, 'Mini grupo II',          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 127, 1, 6, 4, 0, 29)
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 127, 1, 6, 5, 0, 23)	
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 127, 1, 6, 5, 0, 24)
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 127, 1, 6, 5, 0, 225)
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 127, 1, 6, 6, 1, 118)
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 127, 1, 6, 6, 1, 25)	
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 127, 1, 6, 6, 1, 26)	
		                                                                                 
		,(1, 'Berçario I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 1, 0, 1)
		,(1, 'Berçario I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 1, 0, 3)
		,(2, 'Berçario II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 2, 0, 4)
		,(2, 'Berçario II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 2, 0, 6)
		,(3, 'Mini grupo I' ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 3, 0, 11)
		,(3, 'Mini grupo I' ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 3, 0, 27)
		,(4, 'Mini grupo II',          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 4, 0, 28)
		,(4, 'Mini grupo II',          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 4, 0, 29)
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 5, 0, 23)	
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 5, 0, 24)
		,(5, 'Infantil I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 5, 0, 225)
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 6, 1, 118)		
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 6, 1, 25)	
		,(6, 'Infantil II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 128, 1, 6, 6, 1, 26)
		
		,(1, '1º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 143, 1, 3, 1, 0, 194)
		,(2, '2º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 143, 1, 3, 2, 0, 196)
		,(3, '3º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 143, 1, 3, 3, 1, 198)
                                                                                        
		,(1, '1º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 143, 1, 3, 1, 0, 282)
		,(2, '2º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 143, 1, 3, 2, 0, 284)
		,(3, '3º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 143, 1, 3, 3, 1, 286)
		                                                                                
		,(1, '1º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 143, 1, 3, 1, 0, 283)
		,(2, '2º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 143, 1, 3, 2, 0, 285)
		,(3, '3º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 143, 1, 3, 3, 1, 287)

		,(1, '1º Ano'   ,              9, 'Ensino Médio Magistério',                     2, 5, 'SEM CICLO', 0, 1, 144, 1, 4, 1, 0, 101)
		,(2, '2º Ano'   ,              9, 'Ensino Médio Magistério',                     2, 5, 'SEM CICLO', 0, 1, 144, 1, 4, 2, 0, 103)
		,(3, '3º Ano'   ,              9, 'Ensino Médio Magistério',                     2, 5, 'SEM CICLO', 0, 1, 144, 1, 4, 3, 0, 105)
		,(4, '4º Ano'	,              9, 'Ensino Médio Magistério',                     2, 5, 'SEM CICLO', 0, 1, 144, 1, 4, 4, 1, 107)	
		
		,(1, '1ª Série' ,             17, 'Ensino Médio Especial',                       2, 5, 'SEM CICLO', 0, 1, 145, 1, 3, 1, 0, 303)
        ,(2, '2ª Série' ,             17, 'Ensino Médio Especial',                       2, 5, 'SEM CICLO', 0, 1, 145, 1, 3, 2, 0, 304)
		,(3, '3ª Série' ,             17, 'Ensino Médio Especial',                       2, 5, 'SEM CICLO', 0, 1, 145, 1, 3, 3, 1, 305)
	...
	FROM (SELECT distinct grade.*, gc.qt_aula_semanal, depSer.crp_id, depSer.cur_id, depDis.cd_componente_curricular, depDis.dis_nome
		    FROM tmp_grade_mstech grade 
			   ...
			   INNER JOIN DEPARA_SERIE depSer 
					   ON depSer.cd_serie_ensino = grade.cd_serie_ensino 
					  and depSer.cur_id in (136,129,131,132,139,140,141,41,42,128,145)
		 WHERE (dt_fim_validade is null or dt_fim_validade >= GETDATE())
	   ) a 
	...
	UPDATE DEPARA_CURSO_GRADES 
	   SET cur_id = CASE WHEN soma_horas > 40 and cd_etapa_ensino = 5 THEN 138
					 WHEN soma_horas between 32 and 40 and cd_etapa_ensino = 5 and dep.crp_ordem <= 5 THEN 137
					 WHEN soma_horas between 30 and 40 and cd_etapa_ensino = 5 and dep.crp_ordem >= 6 THEN 137
					 WHEN soma_horas < 32 and cd_etapa_ensino = 5 and dep.crp_ordem <= 5 THEN 136
					 WHEN soma_horas < 30 and cd_etapa_ensino = 5 and dep.crp_ordem >= 6 THEN 136
					 WHEN soma_horas >= 31 and cd_grade not in (3541,3542,4285) and cd_etapa_ensino = 13 and dep.crp_ordem <= 6 THEN 130
					 WHEN soma_horas >= 30 and cd_grade not in (3541,3542,4285) and cd_etapa_ensino = 13 and dep.crp_ordem >= 7 THEN 130
					 WHEN soma_horas <= 30 and cd_grade not in (3541,3542,4285) and cd_etapa_ensino = 13 and dep.crp_ordem <= 6 THEN 129
					 WHEN soma_horas <= 29 and cd_grade not in (3541,3542,4285) and cd_etapa_ensino = 13 and dep.crp_ordem >= 7 THEN 129
					 WHEN soma_horas >= 51 and cd_etapa_ensino = 1 THEN 108
					 WHEN soma_horas between 37 and 50 and cd_etapa_ensino = 1 THEN 127
					 WHEN soma_horas between 26 and 36 and cd_etapa_ensino = 1 THEN 126
					 WHEN soma_horas <= 25 and cd_etapa_ensino = 1 THEN 125
					 WHEN cd_etapa_ensino = 6 THEN 131
					 WHEN DEPARA_CURSO_GRADES.cd_serie_ensino = 226 and cd_grade not in (4285) THEN 132
					 WHEN DEPARA_CURSO_GRADES.cd_serie_ensino = 226 and cd_grade = 4285 THEN 133
					 WHEN cd_etapa_ensino = 17 THEN 145
				 END, 
	 ...
	 WHERE dep.cur_id in (select cur_id from DEPARA_CURSOS_DIVIDIDOS) 
	   ...
	   and dep.cur_id not in (139,140,141,41,42) -- já não entrariam por causa da DEPARA_CURSOS_DIVIDIDOS mas só pra garantir
	...
	UPDATE DEPARA_CURSO_GRADES 
	  ...
	  FROM DEPARA_CURSO_GRADES
		   INNER JOIN DEPARA_SERIE dep ON dep.cd_serie_ensino = DEPARA_CURSO_GRADES.cd_serie_ensino
	 WHERE dep.cur_id in (139,140,141,41,42,143,144)
	   and DEPARA_CURSO_GRADES.cur_id is null
	...
	UPDATE DEPARA_CURSO_GRADES 
	 ...
	 WHERE dep.cur_id in (136,137,138)   
     ...
     UPDATE DEPARA_CURSO_GRADES
		SET fl_edFisica = 0 
	  WHERE cur_id in (130,132,133,135,137,138,41,42,125,126,127,128,143,144)
	  
	 UPDATE DEPARA_CURSO_GRADES
		SET fl_edFisica = 0 
	  WHERE cur_id = 136 and crp_id < 6
...
BEGIN
      ...
      FROM (SELECT DEPARA_TURMA.tur_id, es.esc_id, uni.uni_id,
              ...
              FROM tmp_DiarioClasse_turma tur 
				   INNER JOIN GE_ACA_CalendarioAnual cal ON cal.cal_ano = tur.an_letivo and cal.cal_situacao = 1
														AND ((tur.dc_etapa_ensino like '%infantil%' and cal.cal_id = 28) 
															 or (tur.dc_etapa_ensino like '%EJA%' and tur.dc_tipo_periodicidade = 'SEMESTRAL INICIO NO 1º SEMESTRE' and cal.cal_id = 29)
															 or (tur.dc_etapa_ensino like '%EJA%' and tur.dc_tipo_periodicidade = 'SEMESTRAL INICIO NO 2º SEMESTRE' and cal.cal_id = 30)
														     or (tur.dc_etapa_ensino not like '%infantil%' 
																 and tur.dc_etapa_ensino not like '%EJA%' and cal.cal_id = 27))
                   INNER JOIN GE_ESC_Escola es
	...
	select tur.esc_id
	  from GE_TUR_Turma tur
		   inner join GE_TUR_TurmaCurriculo tcr on tcr.tur_id = tur.tur_id and tcr.tcr_situacao <> 3 and tcr.cur_id in (139,140)
		   inner join GE_ACA_CalendarioAnual cal on cal.cal_id = tur.cal_id 
		   inner join _PARAMETROS par ON par.CHAVE = 'ANO_BASE' and cal.cal_ano = par.VALOR
...
BEGIN
	...
	insert into tmpTipoSerieEOL (cd_serie_eol98)
	 select distinct cd_serie_eol98 from BD_PRODAM..v_turma_MSTECH tm
	  where an_letivo = 2021 and cd_serie_ensino is not null
    ...
    SELECT tur.tur_id, cur.cur_id, crr.crr_id, crp.crp_id, 1 AS tcr_prioridade, 1 AS tcr_situacao
     ...
     WHERE tmp.an_letivo = (SELECT CAST(VALOR as int) FROM _PARAMETROS WHERE CHAVE = 'ANO_BASE')
       ...
       and  ((crp.cur_id = 136 and crp.crp_ordem >= 6 and tmp.cd_escola not in (select esc_codigo from _PARAMETROS_ESCOLA_EDUCACAO_FISICA))
			  or (crp.cur_id = 136 and crp.crp_ordem < 6)
			  or (crp.cur_id = 129 and tmp.cd_escola not in (select esc_codigo from _PARAMETROS_ESCOLA_EDUCACAO_FISICA))
			  or crp.cur_id not in (129,131,136,139,140,145)
			)
    ...
    SELECT tur.tur_id, cur.cur_id, crr.crr_id, crp.crp_id, 1 AS tcr_prioridade, 1 AS tcr_situacao
     ...
     WHERE tmp.an_letivo = (SELECT CAST(VALOR as int) FROM _PARAMETROS WHERE CHAVE = 'ANO_BASE')
       and tmp.cd_tipo_turma <> 3
       and DEPARA_SERIE.cur_id in (SELECT cur_id FROM DEPARA_CURSOS_DIVIDIDOS)
	   and  ((crp.cur_id = 136 and crp.crp_ordem >= 6 and tmp.cd_escola in (select esc_codigo from _PARAMETROS_ESCOLA_EDUCACAO_FISICA))
			  or (crp.cur_id = 129 and tmp.cd_escola in (select esc_codigo from _PARAMETROS_ESCOLA_EDUCACAO_FISICA))
			  or (crp.cur_id in (131,139,140,145))
			)
    ...
    SELECT tur.tur_id, cur.cur_id, crr.crr_id, crp.crp_id, 1 AS tcr_prioridade, 1 AS tcr_situacao
     ...
     WHERE tmp.an_letivo = (SELECT CAST(VALOR as int) FROM _PARAMETROS WHERE CHAVE = 'ANO_BASE')
       ...
       AND  ((crp.cur_id = 136 and crp.crp_ordem >= 6 and tmp.cd_escola not in (select esc_codigo from _PARAMETROS_ESCOLA_EDUCACAO_FISICA))
			  or (crp.cur_id = 136 and crp.crp_ordem < 6)
			  or (crp.cur_id = 129 and tmp.cd_escola not in (select esc_codigo from _PARAMETROS_ESCOLA_EDUCACAO_FISICA))
			  or (crp.cur_id NOT IN (129,131,136,145))
			 )
	...
	update tur set tur_codigo = tm.dc_turma_escola, tur_dataAlteracao = GETDATE()
	 ...
	 --porém para o Ensino Infantil isso faz sentido, principalmente porque novas escolas e turmas aparecem a qualquer momento e as grades são menos complexas
		...
		select distinct cur_id, crr_id, tur.esc_id, uni_id, 1 as ces_id, '2020-01-01' as ces_vigenciaInicio,
		  ...
		  from GE_TUR_Turma tur
			   ...
			   on tur.tur_id = tcr.tur_id and tcr.cur_id in (125,126,127,128)
			   inner join GE_ESC_Escola esc
			   on tur.esc_id = esc.esc_id
...
BEGIN	
    ...
    SELECT DEPARA_TURMA.tur_id, dis.dis_id, 1 AS tud_verificador, tmpt.tur_codigo, dis.dis_nome AS tud_nome,
           ...
           tud_naoLancarFrequencia = case when dis.tds_id in (11,12) and crd.cur_id = 136 then 1 
										  when dis.tds_id = 10 and crd.crp_id < 6 then 1 
										  when dis.tds_id in (13,30,32) then 1 
										  else 0 end,
           tud_naoExibirFrequencia = case when dis.tds_id in (11,12) and crd.cur_id = 136 then 1 
										  when dis.tds_id = 10 and crd.crp_id < 6 then 1 
										  when dis.tds_id in (13,30,32) then 1 
										  else 0 end,
     ...
     WHERE dct.cd_tipo_turma not in (2, 3)
       ...
       AND crd_situacao = 1
       AND dis_situacao = 1
       AND (crd.cur_id not in (129,136)
           or (crd.cur_id in (129,136) and dis.dis_cargaHorariaTeorica <> 0))
    ...
    SELECT DEPARA_TURMA.tur_id, dis.dis_id, 1 AS tud_verificador, tmpt.tur_codigo, dis.dis_nome AS tud_nome,
      ...
      FROM #RelacaoTurma tmpt inner join tmp_DiarioClasse_turma dct
           ...
           (select tur_id, cur_id, crr_id, crp_id,
                   ROW_NUMBER() OVER (PARTITION BY tur_id ORDER BY CASE WHEN cur_id in (39,40,41,42,139,140,141) 
...
--                        where cur_nome not like '%EJA%' and cur_situacao <> 3)
    ...
    *************************************************/
	...
	select tudExp.tud_id as tud_idExperiencia, tudTer.tud_id as tud_idTerritorio, 
		   GETDATE() as tte_vigenciaInicio, '2020-12-20' as tte_vigenciaFim, 
...
select cl_codigo, cl_alu_codigo, cl_tur_codigo, cl_datst, cl_cham, des_status, cl_nota,
 ...
 where tur.cd_tipo_turma = 1
   AND tur.cd_etapa_ensino IN (1,2,3,4,5,6,9,10,11,13,14,17) --filtrar apenas os cursos tratados pela integração
...
SELECT cd_escola, cd_turma_escola, tne_nome, tme_nome, cur_codigo,
  ...
  FROM (SELECT tal.cd_escola, tal.cd_turma_escola, CONVERT(VARCHAR(100),
         ...
         WHERE tal.an_letivo = (SELECT CAST(VALOR as int) FROM _PARAMETROS WHERE CHAVE = 'ANO_BASE')
           AND tal.dc_etapa_ensino IS NOT NULL
           AND tal.cd_etapa_ensino IN (1,2,3,4,5,6,9,10,11,13,14,17) --filtrar alunos de EF (Regular e Especial) e EI (Regular e Especial)
           AND tal.cd_modalidade_ensino IS NOT NULL
           AND tal.cd_serie_ensino IS NOT NULL
           AND tal.dc_ciclo_ensino IS NOT NULL) AS t
