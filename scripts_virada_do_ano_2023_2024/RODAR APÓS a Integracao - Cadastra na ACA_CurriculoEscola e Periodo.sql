...
GO
Begin TRAN ACA_CURRICULO 

UPDATE GestaoPedagogica..ACA_CurriculoEscola set ces_vigenciaFim = '2023-12-22' where ces_vigenciaFim  is null and ces_situacao <> 3 
select * from ACA_CurriculoEscola
