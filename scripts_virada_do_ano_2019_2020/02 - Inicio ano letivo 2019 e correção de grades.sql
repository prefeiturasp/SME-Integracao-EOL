...
update Manutencao.._PARAMETROS set VALOR = '2020' where chave = 'ANO_BASE'
update Manutencao.._PARAMETROS set VALOR = '2020-02-05' where chave = 'DATA_CORTE'
...
select cal_id + 5, ent_id, 1 as cal_padrao, 2019 as cal_ano, replace(cal_descricao,'2019','2020'), 
...
update TUR_Turma set tur_dataEncerramento = '2019-12-22', tur_situacao = 5, tur_dataAlteracao = GETDATE() 
