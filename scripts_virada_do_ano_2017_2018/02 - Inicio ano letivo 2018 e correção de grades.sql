...
update Manutencao.._PARAMETROS set VALOR = '2018' where chave = 'ANO_BASE'
update Manutencao.._PARAMETROS set VALOR = '2018-02-05' where chave = 'DATA_CORTE'
...
select cal_id + 5, ent_id, 1 as cal_padrao, 2018 as cal_ano, replace(cal_descricao,'2017','2018'), 
...
update TUR_Turma set tur_dataEncerramento = '2017-12-22', tur_situacao = 5, tur_dataAlteracao = GETDATE() 
 where cal_id in (7,8,9,10,11) and tur_situacao = 1
