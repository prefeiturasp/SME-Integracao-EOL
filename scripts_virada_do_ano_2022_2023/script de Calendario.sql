...
update Manutencao.._PARAMETROS set VALOR = '2023' where chave = 'ANO_BASE'
update Manutencao.._PARAMETROS set VALOR = '2023-02-04' where chave = 'DATA_CORTE'
...
select cal_id + 5, ent_id, 1 as cal_padrao, 2023 as cal_ano, replace(cal_descricao,'2022','2023'), 
...
update TUR_Turma set tur_dataEncerramento = '2022-12-22', tur_situacao = 5, tur_dataAlteracao = GETDATE() 
