    ...
    SELECT alu_id, mtu_id, tud_id, tur_id, mtd_dataMatricula, mtd_numeroChamada,  mtd_situacao
	  FROM (SELECT Tmtd.alu_id, Tmtd.mtu_id, trtd.tud_id, trtd.tur_id,
              ...
              FROM (select cd_turma_escola, cd_escola from tmp_DiarioClasse_turma
                   ...
                   ON alunos_programa.cl_alu_codigo = tmp_DiarioClasse_aluno.cl_alu_codigo
                   AND tmp_DiarioClasse_aluno.crp_ordem not in (35,39,43,47,212,212,210,211) --retirando CIEJA e EJA MODULAR pois eles não devem aparecer
													--no gestão em 2017, mas estavam aparecendo em outras turmas de RP junto com alunos de EF/EJA regular
                   INNER JOIN (select cd_turma_escola from tmp_DiarioClasse_turma
                                where cd_tipo_turma = 1) turma_regular
                   ON tmp_DiarioClasse_aluno.cd_turma_escola = turma_regular.cd_turma_escola
                                  ...
                                  from BD_PRODAM..v_cadastro_professor prf
									   ...
									   inner join DEPARA_SERIE dep on dep.cd_serie_ensino = tm.cd_serie_ensino
											  and ((dep.cur_id in (245,247,248) and dep.crp_ordem > 2) --EF (menos o de 4 horas) a partir do terceiro ano (a pedido do Hygor por email em 05/05/2016)
												    or (dep.cur_id in (39,40,41,42,249,250,251) and dep.crp_ordem in (2,4,6,8))) --EJA apenas algumas séries (a pedido do Hygor por email em 05/05/2016)
                                       inner join BD_PRODAM..v_unidade_educacao_dados_gerais esc
                                       on gc.cd_escola = esc.cd_unidade_educacao
                                 where esc. dc_tipo_unidade_educacao = 'ESCOLA' 
                                   and esc.sg_tp_escola in ('EMEF','EMEFM','CEU EMEF','EMEBS','CIEJA',
...
FROM    ( SELECT    cd_serie_ensino ,
        ...
        INNER JOIN GE_ACA_Curso cur WITH ( NOLOCK ) 
				ON cur.cur_nome COLLATE DATABASE_DEFAULT = _out.crr_nome COLLATE DATABASE_DEFAULT
				   ...
				   or (cur.cur_id = 241 and _out.crr_nome = 'Ensino Médio Regular')
...
GROUP BY 
	...
	values (1, 'Fundamental I Libras', 13, 'Ensino Fundamental 9 Anos',                  2, 5, 'CICLO I',  0, 1, 242, 1, 1, 1, 0, 226)
		...
		,(1, 'EJA ALFABETIZACAO I' ,  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 249, 1, 8, 1, 0, 274)
		,(2, 'EJA ALFABETIZACAO II',  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 249, 1, 8, 2, 0, 275)	
		,(3, 'EJA BASICA I',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 249, 1, 8, 3, 0, 278)	
		,(4, 'EJA BASICA II',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 249, 1, 8, 4, 0, 280)	
		,(5, 'EJA COMPLEMENTAR I',    3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 249, 1, 8, 5, 0, 246)	
		,(6, 'EJA COMPLEMENTAR II',   3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 249, 1, 8, 6, 0, 247)	
		,(7, 'EJA FINAL I',			  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 249, 1, 8, 7, 0, 248)	
		,(8, 'EJA FINAL II',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 249, 1, 8, 8, 1, 249)	
		                                                                                                          
		,(1, 'EJA ALFABETIZACAO I',   3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 249, 1, 8, 1, 0, 276)
		,(2, 'EJA ALFABETIZACAO II',  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 249, 1, 8, 2, 0, 277)	
		,(3, 'EJA BASICA I',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 249, 1, 8, 3, 0, 279)	
		,(4, 'EJA BASICA II',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO I',  0, 1, 249, 1, 8, 4, 0, 281)	
		,(5, 'EJA COMPLEMENTAR I',    3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 249, 1, 8, 5, 0, 265)	
		,(6, 'EJA COMPLEMENTAR II',   3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 249, 1, 8, 6, 0, 266)	
		,(7, 'EJA FINAL I',			  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 249, 1, 8, 7, 0, 267)	
		,(8, 'EJA FINAL II',		  3, 'EJA - Educação de Jovens e Adultos',           2, 5, 'CICLO II', 0, 1, 249, 1, 8, 8, 1, 268)	
		                                                                                
		,(3, 'EJA BASICA I',		  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO I',  0, 1, 250, 1, 8, 3, 0, 292)	
		,(4, 'EJA BASICA II',		  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO I',  0, 1, 250, 1, 8, 4, 0, 294)	
		,(4, 'EJA BASICA II',		  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO I',  0, 1, 250, 1, 8, 4, 0, 295)	
		,(5, 'EJA COMPLEMENTAR I',    11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 250, 1, 8, 5, 0, 261)	
		,(6, 'EJA COMPLEMENTAR II',   11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 250, 1, 8, 6, 0, 270)	
		,(6, 'EJA COMPLEMENTAR II',   11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 250, 1, 8, 6, 0, 262)	
		,(7, 'EJA FINAL I',			  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 250, 1, 8, 7, 0, 263)	
		,(8, 'EJA FINAL II',		  11, 'EJA - Educação de Jovens e Adultos',          2, 5, 'CICLO II', 0, 1, 250, 1, 8, 8, 1, 272)	
		...
		,(1, 'Berçario I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 238, 1, 6, 1, 0, 1)
		,(1, 'Berçario I'   ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 238, 1, 6, 1, 0, 3)
		,(2, 'Berçario II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 238, 1, 6, 2, 0, 4)
		,(2, 'Berçario II'  ,          1, 'Ensino infantil',                             2, 5, 'Infantil', 0, 1, 238, 1, 6, 2, 0, 6)
		...
		,(1, '1º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 253, 1, 3, 1, 0, 194)
		,(2, '2º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 253, 1, 3, 2, 0, 196)
		,(3, '3º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 253, 1, 3, 3, 1, 198)
                                                                                        
		,(1, '1º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 253, 1, 3, 1, 0, 282)
		,(2, '2º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 253, 1, 3, 2, 0, 284)
		,(3, '3º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 253, 1, 3, 3, 1, 286)
		                                                                                
		,(1, '1º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 253, 1, 3, 1, 0, 283)
		,(2, '2º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 253, 1, 3, 2, 0, 285)
		,(3, '3º Modulo'   ,          14, 'Técnico Médio',                               2, 5, 'SEM CICLO', 0, 1, 253, 1, 3, 3, 1, 287)

		,(1, '1º Ano'   ,              9, 'Ensino Médio Magistério',                     2, 5, 'SEM CICLO', 0, 1, 254, 1, 4, 1, 0, 101)
		,(2, '2º Ano'   ,              9, 'Ensino Médio Magistério',                     2, 5, 'SEM CICLO', 0, 1, 254, 1, 4, 2, 0, 103)
		,(3, '3º Ano'   ,              9, 'Ensino Médio Magistério',                     2, 5, 'SEM CICLO', 0, 1, 254, 1, 4, 3, 0, 105)
		,(4, '4º Ano'	,              9, 'Ensino Médio Magistério',                     2, 5, 'SEM CICLO', 0, 1, 254, 1, 4, 4, 1, 107)	
	...
	UPDATE DEPARA_CURSO_GRADES 
	 ...
	 WHERE dep.cur_id in (select cur_id from DEPARA_CURSOS_DIVIDIDOS) 
	   ...
	   and dep.cur_id not in (249,250,251,41,42) -- já não entrariam por causa da DEPARA_CURSOS_DIVIDIDOS mas só pra garantir
	...
	UPDATE DEPARA_CURSO_GRADES 
     ...
     UPDATE DEPARA_CURSO_GRADES
		SET fl_edFisica = 0 
	  WHERE cur_id in (240,242,243,245,247,248,41,42,235,236,237,238,253,232)
		 ...
		 WHERE exists (select ug.usu_id
						 from CoreSSO..SYS_UsuarioGrupo ug
							  inner join CoreSSO..SYS_Grupo gru 
									 ...
									 and gru.sis_id = 237 and gru.vis_id = 1
              ...
              FROM tmp_DiarioClasse_turma tur 
				   INNER JOIN GE_ACA_CalendarioAnual cal ON cal.cal_ano = tur.an_letivo and cal.cal_situacao = 1
														AND ((tur.dc_etapa_ensino like '%infantil%' and cal.cal_id = 53) 
															 or (tur.dc_etapa_ensino like '%EJA%' and tur.dc_tipo_periodicidade = 'SEMESTRAL INICIO NO 1º SEMESTRE' and cal.cal_id = 54)
															 or (tur.dc_etapa_ensino like '%EJA%' and tur.dc_tipo_periodicidade = 'SEMESTRAL INICIO NO 2º SEMESTRE' and cal.cal_id = 55)
